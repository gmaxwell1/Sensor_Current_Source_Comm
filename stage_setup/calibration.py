...
try:
    ...
    from other_useful_functions.general_functions import (
        ensure_dir_exists, save_in_dir,
        transform_between_sensor_stage_coordinates)
...
def grid_2D(CC_X: ConexCC, CC_Y: ConexCC, node: MetrolabTHM1176Node, height, xlim=None, ylim=None,
    ...
    # move actuator(or cube, respectively) to the minimum position and wait
    # until controllers are ready again.
