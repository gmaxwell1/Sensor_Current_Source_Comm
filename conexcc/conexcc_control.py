...
def grid(CC_X: ConexCC,
    ...
    check_no_motion(CC_X, CC2=CC_Y, CC3=CC_Z, verbose=verbose)
    # if everything works fine also redundant, but still good to consider
    ...
    if measurement_function is not None:
        ...
        mean_data, std_data = measurement_function(
            measure_runs, cube, directory=directory, save_mean_data=True, verbose=verbose)
