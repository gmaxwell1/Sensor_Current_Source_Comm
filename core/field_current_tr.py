...
def computeCoilCurrents(B_fieldVector, linear_model=True, offset=False):
    """
    ...
    """
    if linear_model:
        filename = r'fitting_parameters\model_QSM_poly1_nooffset_B2I.sav'
        if offset:
            filename = r'fitting_parameters\model_QSM_poly1_offset_B2I.sav'
    else:
        filename = r'fitting_parameters\model_QSM_poly3_nooffset_B2I.sav'
...
def computeMagField(currVector, linear_model=True, offset=False):
    """
    ...
    """
    if linear_model:
        filename = r'fitting_parameters\model_QSM_poly1_nooffset_I2B.sav'
        if offset:
            filename = r'fitting_parameters\model_QSM_poly1_offset_I2B.sav'
    else:
        filename = r'fitting_parameters\model_QSM_poly3_nooffset_I2B.sav'
...
if __name__ == '__main__':
    ...
    currents = computeCoilCurrents(B1, True)
    print(f'I1 = {currents[0]}A, I2 = {currents[1]}A, I3 = {currents[2]}A')
    B2 = computeMagField(currents, True)
