...
def computeCoilCurrents(B_fieldVector):
    ...
    """
    filename = r'fitting_parameters\model_poly3_QSM_final_B2I.sav'
...
def computeMagField(currVector):
    ...
    Returns:
        Vector of 3 B field components (Bx,By,Bz), as a np.array, units: [mT]
    """
    filename = r'fitting_parameters\model_poly3_QSM_final_I2B.sav'
...
if __name__ == '__main__':
    ...
    B1 = computeMagneticFieldVector(theta=30, phi=20, magnitude=40)
